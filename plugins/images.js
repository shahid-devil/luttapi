...
if (Config.WORKTYPE == 'private') {
    ...
    await message.sendMessage(Buffer(respoimage.data), MessageType.image, {mimetype: Mimetype.png, caption: 'Made by Shahid ser 🙈'})
    ...
    MyPnky.addCommand({pattern: 'luttap', fromMe: true,dontAddCommandList: true}, (async (message, match) => {
...
await message.sendMessage(r_text[i]);
    ...
    MyPnky.addCommand({pattern: 'luttap', fromMe: false,dontAddCommandList: true}, (async (message, match) => {
