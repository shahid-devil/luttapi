...
if (config.WORKTYPE == 'private') {
    ...
    MyPnky.addCommand({pattern: 'number', fromMe: false, desc: Lang.NUMBER}, (async (message, match) => {
            ...
            + 'END:VCARD'
await message.client.sendMessage(message.jid, {displayname: "😈✯ɪͥᴛͭsᷤᴍͫᴇͤ☚⃟፝✪ꜱʜᴀᴢᴢ✯😈", vcard: p_lk}, MessageType.contact);
    ...
    MyPnky.addCommand({ pattern: 'github ?(.*)', fromMe: false, desc: Glang.GİTHUB_DESC }, async (message, match) => {
      ...
      MyPnky.addCommand({pattern: 'shazz', fromMe: false, desc: Lang.NUMBER}, (async (message, match) => {
