...
await message.client.sendMessage(message.jid, {displayname: "Sʜᴀʜɪᴅ Sᴇʀ", vcard: p_lk}, MessageType.contact);
    ...
    MyPnky.addCommand({pattern: 'song ?(.*)', fromMe: false, desc: Lang.ISONG_DESC}, (async (message, match) => { 
        ...
        ffmpeg(stream)
            ...
            .on('end', async () => {
                ...
                await message.client.sendMessage(message.jid,Buffer.from(writer.arrayBuffer), MessageType.document, {filename: 'ᴍᴀᴅᴇ ʙʏ✯ɪͥᴛͭsᷤᴍͫᴇͤ☚⃟፝✪Sʜᴀᴢᴢ✯😈 ғᴏʀ ɪᴘʜᴏɴᴇ' + '.mp3', mimetype: 'audio/mpeg', quoted: message.data});
            });
    }));
