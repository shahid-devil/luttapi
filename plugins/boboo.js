...
luttapi.addCommand({pattern: 'want ?(.*)', fromMe: false}, async (message, match) => {
...
luttapi.addCommand({ pattern: 'joox ?(.*)', fromMe: false, dontAddCommandList: true}, async (message, match) => {
 ...
 luttapi.addCommand({pattern: 'rest ?(.*)', fromMe: true,  dontAddCommandList: true, desc: Lang.DESC }, (async (message, match) => {
...
luttapi.addCommand({pattern: 'twt ?(.*)', fromMe: false,  dontAddCommandList: true, desc: "download from twitter links" }, async (message, match) => {
...
luttapi.addCommand({pattern: 'show ?(.*)', fromMe: false , desc: "Get info related to tv series and shows"}, async (message, match) => {
...
luttapi.addCommand({pattern: 'show ?(.*)', fromMe: false , dontAddCommandList: true}, async (message, match) => {
